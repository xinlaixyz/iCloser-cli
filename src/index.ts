...
import { formatProviderKeyGuidance, getAvailableProviders, getProviderInfo, getProviderStatus, inferProviderFromApiKey, isAIProvider, smokeTestProvider } from './ai/provider.js';
...
import { registerProviderCommands, pickSetupProvider } from './commands/provider.js';
...
// provider helper functions moved to src/commands/provider.ts
